...
// import 'package:flutter_html/html_parser.dart' hide OnTap;
...
class Ui {
  static GetSnackBar SuccessSnackBar(
    ...
    return GetSnackBar(
      titleText: Text(title.tr, style: Get.textTheme.titleLarge!),
      messageText: Text(message!, style: Get.textTheme.bodySmall!),
  ...
  static InputDecoration getInputDecoration(
    ...
    return InputDecoration(
      ...
      suffix: suffix,
      // prefixText: prefix.isBlank == null ? prefixText : null,
      prefix: prefix,
      // errorText: errorText,
    );
  }
